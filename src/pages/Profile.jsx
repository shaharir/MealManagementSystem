      ...
      <div className="row">
        <div className="col-md-4">
          <div className="card shadow-lg">
            ...
            >
              <h5 className="card-title fw-bolder">Shahariar Sumon</h5>
              <p className="card-text">Software Developer at Shunno IT</p>
            </div>
          </div>
        </div>
        <div className="col-md-8">
          <div className="card shadow-sm">
            <div
              className="card-header text-white fw-bolder"
              style={{ backgroundColor: "#001529" }}
            >
              Profile Details
            </div>
            <div className="card-body">
              <h5 className="card-title fw-bolder">About Me</h5>
              <p className="card-text text-muted">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                scelerisque urna id neque volutpat, a hendrerit orci pharetra.
              </p>
              <h5 className="card-title fw-bolder">Skills</h5>
              <p className="card-text">
                ...
                <span className=" me-2 text-primary">
                  {" "}
                  <i className="bi bi-c-circle"></i>C language
                </span>
              </p>
              <h5 className="card-title fw-bolder">Contact Information</h5>
              <p className="card-text">
                <i className="bi bi-envelope fs-5 me-2"></i>{" "}
                <span className="text-primary">shaharir.cse@gmail.com</span>
              </p>
              <p className="card-text">
                <i className="bi bi-telephone fs-5 me-2"></i>
                <span className="text-primary">+8801304396737</span>
              </p>
            </div>
          </div>
        </div>
